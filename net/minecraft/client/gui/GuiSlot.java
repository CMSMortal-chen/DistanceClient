...
public abstract class GuiSlot
{
    ...
    public void drawScreen(int mouseXIn, int mouseYIn, float p_148128_3_)
    {
        if (this.field_178041_q)
        {
            ...
            GL11.glEnable(3089);
            RenderUtil.prepareScissorBox( left,top + 1,right,bottom);

            this.mouseX = mouseXIn;
            this.mouseY = mouseYIn;
            //RenderUtil.drawRect(left,top + 1,right,bottom,new Color(0,0,0,80).getRGB());
            ...
            worldrenderer.pos((double)this.right, (double)this.top, 0.0D).tex(1.0D, 0.0D).color(0, 0, 0, 120).endVertex();
            worldrenderer.pos((double)this.left, (double)this.top, 0.0D).tex(0.0D, 0.0D).color(0, 0, 0, 120).endVertex();
            tessellator.draw();
            worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
            worldrenderer.pos((double)this.left, (double)this.bottom, 0.0D).tex(0.0D, 1.0D).color(0, 0, 0, 120).endVertex();
            worldrenderer.pos((double)this.right, (double)this.bottom, 0.0D).tex(1.0D, 1.0D).color(0, 0, 0, 120).endVertex();
            ...
            if (j1 > 0)
            {
                ...
                worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
                worldrenderer.pos((double)i, (double)this.bottom, 0.0D).tex(0.0D, 1.0D).color(0, 0, 0, 120).endVertex();
                worldrenderer.pos((double)j, (double)this.bottom, 0.0D).tex(1.0D, 1.0D).color(0, 0, 0, 120).endVertex();
                worldrenderer.pos((double)j, (double)this.top, 0.0D).tex(1.0D, 0.0D).color(0, 0, 0, 120).endVertex();
                worldrenderer.pos((double)i, (double)this.top, 0.0D).tex(0.0D, 0.0D).color(0, 0, 0, 120).endVertex();
                tessellator.draw();
                worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
            ...
            Blur.blurAreaBoarderXY(0,0, RenderUtil.width(),this.top + 1);
            RenderUtil.drawRect(0,0, RenderUtil.width(),this.top+1.5f,new Color(0,0,0,80).getRGB());
            Blur.blurAreaBoarderXY(0,bottom , RenderUtil.width(),height);
            RenderUtil.drawRect(0,bottom - 1.5, RenderUtil.width(),height,new Color(0,0,0,80).getRGB());
