...
import my.distance.module.modules.player.InvCleaner;
import my.distance.module.modules.world.ChestStealer;
...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        //this.buttonList.add(new GuiButton(5150, 1, 1, 200, 20, "Toggle KillAura&InvManager&ChestStealer"));
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        if (isKeyComboCtrlX(keyCode)) {
            ...
            if (ModuleManager.getModuleByClass(InvCleaner.class).isEnabled()){
                ModuleManager.getModuleByClass(InvCleaner.class).setEnabled(false);
            }
            if (ModuleManager.getModuleByClass(ChestStealer.class).isEnabled()){
                ModuleManager.getModuleByClass(ChestStealer.class).setEnabled(false);
            }
        }
    ...
    {
        if (button.id == 5150) {
            if (ModuleManager.getModuleByClass(InvCleaner.class).isEnabled())ModuleManager.getModuleByClass(InvCleaner.class).setEnabled(false);
            if (ModuleManager.getModuleByClass(ChestStealer.class).isEnabled())ModuleManager.getModuleByClass(ChestStealer.class).setEnabled(false);
            if (ModuleManager.getModuleByClass(KillAura.class).isEnabled())ModuleManager.getModuleByClass(KillAura.class).setEnabled(false);
        }
    }
}
