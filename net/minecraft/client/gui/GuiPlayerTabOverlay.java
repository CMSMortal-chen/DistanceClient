...
public class GuiPlayerTabOverlay extends Gui {
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
        ...
        if (list1 != null) {
            drawRect(width / 2 - l1 / 2 - 1, k1 + (int) GuiIngame.tabY - 1, width / 2 + l1 / 2 + 1, k1 + (int) GuiIngame.tabY + list1.size() * this.mc.fontRendererObj.FONT_HEIGHT, Integer.MIN_VALUE);

            for (String s3 : list1) {
                int i2 = this.mc.fontRendererObj.getStringWidth(s3);
                this.mc.fontRendererObj.drawStringWithShadow(s3, (float) (width / 2 - i2 / 2), (float) k1 + (int) GuiIngame.tabY, -1);
        ...
        drawRect(width / 2 - l1 / 2 - 1, k1 + (int) GuiIngame.tabY - 1, width / 2 + l1 / 2 + 1, k1 + (int) GuiIngame.tabY + i4 * 9, Integer.MIN_VALUE);

        for (int k4 = 0; k4 < l3; ++k4) {
            int l4 = k4 / i4;
            int i5 = k4 % i4;
            int j2 = j1 + l4 * i1 + l4 * 5;
            int k2 = k1 + (int) GuiIngame.tabY + i5 * 9;
        ...
        if (list2 != null) {
            hight = k1 + i4 * 9 + 1 + list2.size() * this.mc.fontRendererObj.FONT_HEIGHT;
            k1 = k1 + (int) GuiIngame.tabY + i4 * 9 + 1;
    ...
    public static List<EntityPlayer> getPlayerList() {
        ...
        List players = field_175252_a.sortedCopy(var4.getPlayerInfoMap());
