...
import my.distance.api.events.World.EventEntityMovement;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn)
    {
        ...
        this.netManager.sendPacket(new C17PacketCustomPayload("MC|Brand", (new PacketBuffer(Unpooled.buffer())).writeString("fml,forge")));
    }
    ...
    public void handleEntityMovement(S14PacketEntity packetIn)
    {
        ...
        if (entity != null)
        {
            ...
            EventBus.getInstance().register(new EventEntityMovement(entity));
            entity.onGround = packetIn.getOnGround();
        }
    }
    ...
    public void addToSendQueue(Packet p_147297_1_)
    {
        ...
        EventBus.getInstance().register(packetSent);
        ...
        if (entity != null)
        {
            ...
            else
            {
                ...
                for (S20PacketEntityProperties.Snapshot s20packetentityproperties$snapshot : packetIn.func_149441_d())
                {
                    ...
                    {
                        iattributeinstance = baseattributemap.registerAttribute(new RangedAttribute((IAttribute)null, s20packetentityproperties$snapshot.func_151409_a(), 0.0D, Double.MIN_NORMAL, Double.MAX_VALUE));
                    }
