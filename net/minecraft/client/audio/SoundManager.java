...
import my.distance.api.events.World.EventSound;
...
public class SoundManager {
    ...
    public void playSound(ISound p_sound) {
        EventSound eventSound = new EventSound(p_sound);
        EventBus.getInstance().register(eventSound);

        if (this.loaded && !eventSound.isCancelled()) {
