...
import my.distance.module.modules.render.ItemPhysic;
import my.distance.util.render.ClientPhysic;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (ModuleManager.getModuleByClass(ItemPhysic.class).isEnabled()){
            i = ClientPhysic.func_177077_a(entity, x, y, z, partialTicks, ibakedmodel);
        }else {
            i = this.func_177077_a(entity, x, y, z, partialTicks, ibakedmodel);
        }
        for (int j = 0; j < i; ++j)
        {
