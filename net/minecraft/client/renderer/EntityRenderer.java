...
import my.distance.module.modules.combat.Reach;
import my.distance.module.modules.render.FullBright;
import my.distance.module.modules.render.NoHurtCam;
import my.distance.module.modules.render.ViewClip;
import my.distance.module.modules.render.Xray;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
		NoHurtCam NoHurtCamA =  (NoHurtCam)Client.instance.getModuleManager().getModuleByClass(NoHurtCam.class);
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase && !NoHurtCamA.isEnabled())
        {
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (movingobjectposition != null)
                    {
                        ...
                        if ((d7 < d3) && (!Client.instance.getModuleManager().getModuleByClass(ViewClip.class).isEnabled())){  
        ...
        if (this.lightmapUpdateNeeded) {
            ...
            if (world != null) {
                if (ModuleManager.getModuleByClass(Xray.class).isEnabled()) {
                    int color = new Color(255,255,255,((Xray)ModuleManager.getModuleByClass(Xray.class)).getOpacity()).getRGB();
                    ...
                    for (int i = 0; i < 256; ++i) {
                        ...
                        float f16 = (ModuleManager.getModuleByClass(Xray.class).isEnabled() || ModuleManager.getModuleByClass(FullBright.class).isEnabled()) ? 10000f : this.mc.gameSettings.gammaSetting;
                        float f17 = 1.0F - f8;
                        float f13 = 1.0F - f9;
                        float f14 = 1.0F - f10;
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        RenderUtil.guiDelta = (thisFrame - this.lastFrame);
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
		...
		GL11.glPushMatrix();
		EventBus.getInstance().register(new EventRender3D(partialTicks));
