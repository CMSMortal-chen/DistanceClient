...
import my.distance.api.events.Render.EventBlockRenderSide;
...
public class Block
{
	...
	public int getMixedBrightnessForBlock(IBlockAccess worldIn, BlockPos pos) {
		...
		int i = worldIn.getCombinedLight(pos,
				ModuleManager.getModuleByClass(Xray.class).isEnabled() ? 100000
						: block.getLightValue());
	...
	public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
		...
		if (ModuleManager.getModuleByClass(Xray.class).isEnabled() && !Xray.CAVE.getValue()
			...
			return side == EnumFacing.DOWN && this.minY > 0.0D
                    ...
                    || (side == EnumFacing.EAST && this.maxX < 1.0D
