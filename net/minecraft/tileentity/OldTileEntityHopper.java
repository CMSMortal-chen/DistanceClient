...
public class OldTileEntityHopper extends TileEntityLockable implements IHopper, ITickable
{
    ...
    private static ItemStack insertStack(IInventory inventoryIn, ItemStack stack, int index, EnumFacing side)
    {
        ...
        if (canInsertItemInSlot(inventoryIn, stack, index, side))
        {
            ...
            if (flag)
            {
                if (inventoryIn instanceof OldTileEntityHopper)
                {
                    OldTileEntityHopper tileentityhopper = (OldTileEntityHopper)inventoryIn;
