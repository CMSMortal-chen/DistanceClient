...
public class OldTileEntityBeacon extends TileEntityLockable implements ITickable, IInventory
{
    /** List of effects that Beacon can apply */
    public static final Potion[][] effectsList = new Potion[][] {{Potion.moveSpeed, Potion.digSpeed}, {Potion.resistance, Potion.jump}, {Potion.damageBoost}, {Potion.regeneration}};
    protected final List<OldTileEntityBeacon.BeamSegment> beamSegments = Lists.newArrayList();
    ...
    protected int primaryEffect;

    /** Secondary potion effect given by this beacon. */
    protected int secondaryEffect;
    ...
    public void updateSegmentColors()
    {
        ...
        OldTileEntityBeacon.BeamSegment tileentitybeacon$beamsegment = new OldTileEntityBeacon.BeamSegment(EntitySheep.getDyeRgb(EnumDyeColor.WHITE));
        ...
        for (int i1 = k + 1; i1 < 256; ++i1)
        {
            ...
            {
                tileentitybeacon$beamsegment = new OldTileEntityBeacon.BeamSegment(afloat);
                this.beamSegments.add(tileentitybeacon$beamsegment);
            }
    ...
    public List<OldTileEntityBeacon.BeamSegment> getBeamSegments()
    {
