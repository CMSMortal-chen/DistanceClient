...
{
    public boolean getIsItemStackEqual2(ItemStack p_179549_1_)
    {
        return this.isItemStackEqual2(p_179549_1_);
    }
    private boolean isItemStackEqual2(ItemStack other) {
        return this.stackSize != other.stackSize ?
                false : (this.item != other.item ?
                false : (this.stackTagCompound == null && other.stackTagCompound != null ? false : this.stackTagCompound == null || this.stackTagCompound.equals(other.stackTagCompound)));
    }
    ...
    public String getDisplayName()
    {
        ...
        if(this.getItem() != null) {
            s = this.getItem().getItemStackDisplayName(this);
        }
