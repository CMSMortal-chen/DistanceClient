...
public final class AStarCustomPathFinders {
    ...
    public AStarCustomPathFinders(CustomVec3 startCustomVec3, CustomVec3 endCustomVec3) {
    ...
    private static boolean isBlockSolid(BlockPos pos) {
        Block block = AStarCustomPathFinders.MC.theWorld.getBlockState(pos).getBlock();
    ...
    public void compute(int loops, int depth) {
        ...
        ArrayList<CustomVec3> initPath = new ArrayList<>();
