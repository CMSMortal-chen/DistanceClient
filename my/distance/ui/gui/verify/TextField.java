...
public class TextField extends Gui
{
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                //RenderUtil.drawFastRoundedRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, height / 2f,new Color(255,255,255,80).getRGB());
                RenderUtil.drawFastRoundedRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, 1,new Color(255,255,255, 150).getRGB());
                //if ()
                RenderUtil.drawRect(this.xPosition + anim - 1, this.yPosition + this.height - 0.3f, this.xPosition - anim + this.width + 1, this.yPosition + this.height + 1, new Color(0, 196, 255, 255).getRGB());
