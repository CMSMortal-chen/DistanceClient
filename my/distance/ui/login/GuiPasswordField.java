...
public final class GuiPasswordField extends Gui {
	...
	public GuiPasswordField(final FontRenderer p_i1032_1_, final int p_i1032_2_, final int p_i1032_3_,
			final int p_i1032_4_, final int p_i1032_5_) {
		super();
	...
	public void drawTextBox() {
		if (this.func_146176_q()) {
			if (this.func_146181_i()) {
				Gui.drawRect(this.field_146209_f - 1, this.field_146210_g - 1,
						this.field_146209_f + this.field_146218_h + 1, this.field_146210_g + this.field_146219_i + 1,
						-6250336);
				Gui.drawRect(this.field_146209_f, this.field_146210_g, this.field_146209_f + this.field_146218_h,
			...
			final String var4 = this.field_146211_a
					.trimStringToWidth(this.field_146216_j.substring(this.field_146225_q), this.func_146200_o());
			...
			final int var8 = this.field_146215_m ? (this.field_146210_g + (this.field_146219_i - 8) / 2)
					: this.field_146210_g;
			int var9 = var7;
			if (var3 > var4.length()) {
				var3 = var4.length();
			...
			final boolean var11 = this.field_146224_r < this.field_146216_j.length()
			...
			if (var3 != var2) {
				final int var13 = var7
						+ this.field_146211_a.getStringWidth(var4.substring(0, var3).replaceAll(".", "*"));
	...
	private void func_146188_c(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
		...
		var6.getWorldRenderer().pos(p_146188_1_, p_146188_4_, 0.0);
		var6.getWorldRenderer().pos(p_146188_3_, p_146188_4_, 0.0);
		var6.getWorldRenderer().pos(p_146188_3_, p_146188_2_, 0.0);
		var6.getWorldRenderer().pos(p_146188_1_, p_146188_2_, 0.0);
		var6.draw();
		GL11.glDisable(3058);
		GL11.glEnable(3553);
	}
	...
	public void func_146199_i(int p_146199_1_) {
		...
		if (this.field_146211_a != null) {
			...
			final String var4 = this.field_146211_a
					.trimStringToWidth(this.field_146216_j.substring(this.field_146225_q), var3);
	...
	public void mouseClicked(final int p_146192_1_, final int p_146192_2_, final int p_146192_3_) {
		final boolean var4 = p_146192_1_ >= this.field_146209_f
		...
		if (this.field_146213_o && p_146192_3_ == 0) {
			...
			final String var6 = this.field_146211_a
					.trimStringToWidth(this.field_146216_j.substring(this.field_146225_q), this.func_146200_o());
