package my.distance.ui.textfield;
...
public class UIPasswordField extends GuiTextField {
    ...
    public UIPasswordField(int componentId, net.minecraft.client.gui.FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
        super(componentId, fontrendererObj, x, y, par5Width, par6Height);
        this.id = componentId;
        this.fontRendererInstance = Client.FontLoaders.Chinese14;
        this.xPosition = x;
        this.yPosition = y;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            int var10000;
            if (this.isEnabled) {
                var10000 = this.enabledColor;
            } else {
                var10000 = this.disabledColor;
            }
            ...
            if (k != j) {
                ...
                Gui.drawRect(k1, i1 - 1, l1 - 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, SuperLib.reAlpha(Colors.DARKBLUE.c, 0.3F));
            }
        }
