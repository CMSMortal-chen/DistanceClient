...
//					}
                ...
                Client.FontLoaders.Chinese13.drawStringWithShadow(string, -n4 / 2.0f + 2.5f, -10.0f, Colors.WHITE.c);
                ...
                RenderUtil.drawRect(-n4 / 2.0f, -2.0f, Math.min(n4, n4 / 2.0f - n4 / 2.0f * (1.0f - n11) * 2.0f), 0.0f, SuperLib.reAlpha(n12, 0.8f));
                if (armor) {
